import { obtenerProducto } from "./funciones/funciones";
    ...
    <main className="flex h-screen">
      <div className="flex-1 bg-white">
        ...
        <div>
          ...
          >
            <h2 className="text-3xl font-bold bg-gray-300 rounded-full px-4 py-1 inline-block mb-4">
            ...
            <div className="mb-6">
              ...
              <p className="text-xl text-black">{producto.proveedor?.nombre || "Sin proveedor"}</p>
              <p className="text-sm text-gray-600">{producto.proveedor?.direccion || "Sin dirección"}</p>
